...
SERVICE_CONNECT_DATA = "localhost:5006"

_NOT_FOUND = pb2.TransactionResponse.StatusCode.USER_NOT_FOUND
_ERR = pb2.TransactionResponse.StatusCode.ERROR
_OK = pb2.TransactionResponse.StatusCode.OK
...
class MoneyTransactionsServer(pb2_grpc.MoneyTransactonServicer):
    def deposit(self, request, context):
        ...
        try:
            ...
            if not res:
                return pb2.TransactionResponse(code=_NOT_FOUND, message="User not found.")
        ...
        return pb2.TransactionResponse(code=_OK, message="Successfully deposit money.")
