...
import user_balance_pb2 as user__balance__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in user_balance_pb2_grpc.py depends on'
...
def add_UserBalanceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('user_balance.UserBalance', rpc_method_handlers)
...
class UserBalance(object):
    ...
    @staticmethod
    def register_user_balance(request,
            target,
            options=(),
