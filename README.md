...
Golang-сервис, имитирующий работу слот-машины: генерирует случайные числа и передаёт поток сгенерированных значений на клиент (`service_front`). При проверке баланса обращается к `service_balance`
